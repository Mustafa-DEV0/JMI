...
import styles from "./Doctordashbord.module.css";
  ...
  const filteredAppointments = appointments.filter(
    (appointment) =>
      appointment.patientName
        .toLowerCase()
        .includes(searchQuery.toLowerCase()) && appointment.status === activeTab
  );
                ...
                >
                  ...
                  <div className={styles.appointmentActions}>
                    ...
                    {appointment.status === "upcoming" && (
                      <button
                        onClick={() =>
                          handleAppointmentAction(appointment.id, "remove")
                        }
