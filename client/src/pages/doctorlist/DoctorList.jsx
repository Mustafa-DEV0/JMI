...
function DoctorList() {
  ...
  const fetchDoctors = async () => {
    try {
      ...
      const url = `http://localhost:5000/doctor/list?${queryParams}`;
      ...
      <div className={styles.mainContent}>
        <div className={styles.searchBar}>
          ...
          <input
            ...
            onChange={(e) => {setFilters({ ...filters, search: e.target.value }); handleApplyFilters()} }
          />
        </div>
                ...
                <div className={styles.doctorInfo}>
                  ...
                  <div className={styles.doctorDetails}>
                    ...
                    <p className={styles.qualifications}>
                      {doctor?.qualification || "NA"}
                    </p>
                    <p className={styles.consultationFee}>
                      &#8377;
                      {doctor?.consultationFee || "NA"}{" "}
                      Consultation Fee
                    </p>
